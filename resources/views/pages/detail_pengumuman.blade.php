    ...
    <section class="mb-16">
        <div class="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <aside class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <h2 class="text-base font-semibold text-gray-900 mb-3">Bagikan</h2>
                    <div class="flex gap-3">
                        <a href="https://wa.me/?text={{ urlencode(url()->current()) }}" target="_blank" class="px-3 py-2 rounded-lg bg-green-50 text-green-700 hover:bg-green-100">WhatsApp</a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank" class="px-3 py-2 rounded-lg bg-blue-50 text-blue-700 hover:bg-blue-100">Facebook</a>
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}" target="_blank" class="px-3 py-2 rounded-lg bg-sky-50 text-sky-700 hover:bg-sky-100">X/Twitter</a>
                    </div>
                </div>
            </aside>
        </div>
