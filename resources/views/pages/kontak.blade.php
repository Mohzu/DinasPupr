...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <div class="flex flex-col gap-8">
                <div>
                    ...
                    <h1 class="mt-4 text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900">Kontak Dinas PUPR<br class="hidden sm:block"> Kabupaten Garut</h1>
                    <p class="mt-4 text-base sm:text-lg text-gray-600 max-w-2xl">Silakan gunakan informasi atau form di bawah untuk pertanyaan, kolaborasi, atau permohonan informasi layanan kami.</p>
                </div>
                <div class="relative">
                    <div class="rounded-3xl border border-blue-100 bg-gradient-to-br from-white to-blue-50 p-4 sm:p-6 shadow-xl">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            <div class="p-4 rounded-2xl bg-white/80 border border-gray-100">
                                <div class="flex items-start gap-3">
                                    <div class="w-9 h-9 flex-shrink-0 rounded-xl bg-blue-600 text-white flex items-center justify-center shadow">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800 text-sm leading-relaxed">Jl. Raya Samarang No.117, Sukagalih, Kec. Tarogong Kidul, Kabupaten Garut, Jawa Barat 44151</p>
                                    </div>
                                </div>
                            </div>
                            <div class="p-4 rounded-2xl bg-white/80 border border-gray-100">
                            ...
                            <div class="p-4 rounded-2xl bg-white/80 border border-gray-100">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800 break-all">pupr@garutkab.go.id</p>
                                    </div>
                                </div>
                            </div>
                            <div class="p-4 rounded-2xl bg-white/80 border border-gray-100">
    ...
    <!-- Kontak Form + Peta -->
    <section class="pb-16">
        <div class="container mx-auto px-4 sm:px-6 flex flex-col gap-6">
            <!-- Peta / Lokasi -->
            <div id="lokasi">
                <div class="rounded-3xl border border-gray-100 bg-white p-4 shadow-sm">
                    <div class="h-56 sm:h-72 rounded-2xl overflow-hidden border border-blue-100 bg-white">
            ...
            <!-- Form Kontak -->
            <div>
                <div class="rounded-3xl border border-gray-100 bg-white/80 p-5 sm:p-8 shadow-xl">
                    ...
                    <p class="text-gray-500 mb-6 text-sm sm:text-base">Kirim pertanyaan atau pesan umum Anda. Kami akan membalas melalui email.</p>
                    
                    <form id="contact-form" action="{{ route('kontak.store') }}" method="POST" class="flex flex-col gap-4">
                        @csrf
                        ...
                        <div>
                            ...
                            <textarea name="pesan" rows="5" class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Tulis pesan Anda" required></textarea>
                        </div>

                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <p class="text-xs text-gray-500">Untuk laporan/aduan menggunakan halaman Pengaduan.</p>
                            <button type="submit" id="submit-btn" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 active:scale-[.99] transition w-full sm:w-auto">
