        ...
        <div class="flex justify-between items-center">
            ...
            <div class="lg:hidden" x-data="{ mobileMenuOpen: false }">
                ...
                <div x-show="mobileMenuOpen" 
                    ...
                    <!-- Mobile Beranda -->
                    <a href="{{ route('home') }}" class="block px-6 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all duration-200">
                        Beranda
                    </a>
                    ...
                    <div x-data="{ layananOpen: false }">
                        ...
                        <div x-show="layananOpen" 
                             ...
                             x-transition:leave-end="opacity-0 max-h-0"
                             class="bg-gray-50 overflow-hidden">
                            <a href="{{ route('pengaduan') }}" class="block px-10 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200">Pengaduan</a>
                            <a href="{{ route('kontak') }}" class="block px-10 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200">Kontak</a>
                        </div>
                    </div>
                    <a href="{{ route('dokumen') }}" class="block px-6 py-3 text-gray-700 hover:text-blue-600 hover:bg-blue-50 font-medium transition-all duration-200">Dokumen</a>
                </div>
            </div>
        </div>
    </nav>
