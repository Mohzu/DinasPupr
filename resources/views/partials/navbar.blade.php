                ...
                <ul class="hidden lg:flex items-center space-x-10 text-sm font-semibold text-gray-700">
                    ...
                    <li x-data="{ open: false }" class="relative">
                        ...
                        <ul x-show="open" 
                            ...
                            <li>
                                <a href="{{ route('struktur-organisasi') }}" class="block px-5 py-3 text-gray-700 hover:text-blue-600 font-medium transition-all duration-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 hover:translate-x-1">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                            ...
                            <li>
                                <a href="{{ route('visi-misi') }}" class="block px-5 py-3 text-gray-700 hover:text-blue-600 font-medium transition-all duration-200 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 hover:translate-x-1">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                                        <span>Visi & Misi</span>
                                    </div>
                    ...
                    <div x-show="mobileMenuOpen" 
                        ...
                        <div x-data="{ profilOpen: false }">
                            ...
                            <div x-show="profilOpen" 
                                ...
                                <a href="{{ route('struktur-organisasi') }}" class="block px-10 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200">Struktur Organisasi</a>
                                <a href="{{ route('visi-misi') }}" class="block px-10 py-2 text-sm text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-all duration-200">Visi & Misi</a>
                            </div>
                        </div>
