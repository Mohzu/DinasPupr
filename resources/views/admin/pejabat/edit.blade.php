...
@section('title', 'Edit Pejabat Struktural - Admin Panel')
@section('page-title', 'Edit Pejabat Struktural')
@section('page-description', 'Edit pejabat: ' . $pejabat->nama)

@section('content')
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Edit Pejabat Struktural</h2>
        <p class="text-gray-500 mt-1 text-sm">Edit pejabat: {{ $pejabat->nama }}</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8">
        <form action="{{ route('admin.pejabat.update', $pejabat) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama', $pejabat->nama) }}" required
            ...
            <div>
                ...
                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $pejabat->jabatan) }}" required
                       class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all outline-none"
            ...
            <div>
                ...
                <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $pejabat->urutan) }}" min="0"
                       class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all outline-none"
            ...
            <div>
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" name="aktif" id="aktif" value="1" {{ old('aktif', $pejabat->aktif) ? 'checked' : '' }}
