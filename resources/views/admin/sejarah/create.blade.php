...
@section('page-title', 'Tambah Sejarah')
@section('page-description', 'Buat konten sejarah baru')

@section('content')
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Tambah Sejarah</h2>
        <p class="text-gray-500 mt-1 text-sm">Buat konten sejarah baru untuk ditampilkan di website</p>
    </div>
        ...
        <form action="{{ route('admin.sejarah.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="15" required
                          ...
                          placeholder="Tulis konten sejarah di sini...">{{ old('content') }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600 flex items-center gap-1">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
