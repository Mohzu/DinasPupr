...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Tambah Pengumuman</h2>
        <p class="text-gray-500 mt-1 text-sm">Buat pengumuman baru untuk ditampilkan di website</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8">
        <form action="{{ route('admin.pengumuman.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Lampiran -->
            <div>
                <label for="lampiran" class="block text-sm font-semibold text-gray-700 mb-2">Lampiran (Opsional)</label>
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-green-400 transition-colors">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500">PDF, DOC, DOCX hingga 4MB</p>
                    </div>
                </div>
                @error('lampiran')
                    <p class="mt-1 text-sm text-red-600 flex items-center gap-1">
